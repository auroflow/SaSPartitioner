...
import cn.edu.zju.daily.metricflux.task.tdigest.operator.FixedIntervalTDigestCombiner;
import cn.edu.zju.daily.metricflux.task.tdigest.operator.TDigestCombiner;
import cn.edu.zju.daily.metricflux.task.tdigest.operator.TDigestReducer;
...
public class TDigestExecutor {
    ...
    public static void execute(
            Parameters params,
            SourceFunction<TDigestRecord> sourceFunction,
        ...
        Partitioner<Integer, TDigestRecord> partitioner;
        TDigestCombiner combiner;
        KeySelector<TDigestState, Integer> reduceKeySelector;
        TDigestReducer reducer = new TDigestReducer(params.getWindowSize());
        KeySplittingPipeline<Integer, TDigestRecord, TDigestState, TDigestState> pipeline;
        ...
        // Combiner
        combiner =
                new FixedIntervalTDigestCombiner(
                        workloadRatio,
                        jobManagerHost,
                        jobManagerPort,
                        params.getMetricCollectorPort(),
        ...
        if (isDistributionAware) {
            ...
            reduceKeySelector = TDigestState::getKey;
        }
        ...
        SingleOutputStreamOperator<TDigestRecord> source =
